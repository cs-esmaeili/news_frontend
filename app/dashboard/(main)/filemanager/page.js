...
import { BiCollapse, BiSolidFolderPlus, BiSolidEdit } from 'react-icons/bi';
import { IoMdTrash } from 'react-icons/io';
import { PiUploadBold, PiKeyReturnBold, PiMagnifyingGlassBold } from 'react-icons/pi';
    ...
    return (
        <Container className={styles.container} fluid >
            <Row className={styles.mainRow}>
                <Col className={styles.filesPanel}  >
